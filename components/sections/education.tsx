        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
          {education.map((item, i) => (
            <motion.div
              ...
              className="group rounded-md border border-border bg-surface-card p-7 transition-colors duration-300 ease-premium hover:bg-surface-hover hover:border-ink/20"
            >
              <div className="flex h-12 w-12 items-center justify-center overflow-hidden rounded-sm border border-border bg-base">
                <Image
                  src={item.logo}
